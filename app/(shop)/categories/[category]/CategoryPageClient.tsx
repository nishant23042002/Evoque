// category/[category]/CategoryPageClient.tsx
...
const ProductCategoryPage = ({ category }: Props) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="w-20 flex items-center justify-center">
                                    <p className={clsx(
                                        "mt-1 text-[11px] text-center truncate font-medium tracking-tighter hover:text-primary",
